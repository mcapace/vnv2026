...
export const metadata = {
  title: "The Best Places to Stay in Napa Valley | Wine Spectator × Visit Napa Valley",
  description:
    "From vineyard-edge bungalows at Carneros Resort to the mineral-spa heritage of Mount View Hotel & Inn — Wine Spectator's guide to staying in Napa Valley.",
};
    ...
    <main className="hub-page relative flex min-h-screen w-full flex-col">
      ...
      <div className="relative h-[60vh] min-h-[480px] flex-shrink-0 overflow-hidden bg-[var(--hub-navy)]">
        <img
          ...
          alt="Napa Valley accommodations"
      ...
      >
        <div style={{ maxWidth: "48rem", margin: "0 auto" }}>
          ...
          <p className="hub-prose-serif" style={{ color: "var(--hub-muted)" }}>
            Article content coming soon. The full guide to staying in Napa Valley will be published
            here shortly.
          </p>
